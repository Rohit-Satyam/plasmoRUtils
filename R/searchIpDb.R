...
#' 
#' To view list of species covered by InParanoiDB 9, use [listipdb()] function.   
#'
#' @import dplyr purrr
...
#' @param ... Additional arguments that can be passed to [toGeneid()] function. This comes in very handy if you are working with parasite gene IDs other than \emph{Plasmodium}.
#' 
