...
#'
#' A convenience function to quickly perform GO Term Enrichment analysis using TopGO.The results then can be plotted using [easyGOPlot()]
#'
#' @import dplyr tibble
...
#' @param algo Argument to specify which algorithm to be used for enrichment by topGO. For possible options use [topGO::whichAlgorithms()]
#' @param stats Argument to specify the statistical test to be used for enrichment by topGO. For possible values use [topGO::whichTests()]. Default: "ks".
