...
#'
#' A convenience function to quickly plot the results of [easytopGO()] or ORA results obtained from VEupathDB component databases.
#'
#' @import dplyr
