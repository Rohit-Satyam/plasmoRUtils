...
> Note: Programmatic access to VEuPathDB is not free anymore. To use
> VEuPathDB databases associated function user need to supply API key.
...
[![Last-changedate](https://img.shields.io/badge/last%20change-2026--00--22-yellowgreen.svg)]([https://github.com/Rohit-Satyam/plasmoRUtils/commits/main](https://github.com/Rohit-Satyam/plasmoRUtils/commits/release/1.1.2/))
[![Lifecycle:
