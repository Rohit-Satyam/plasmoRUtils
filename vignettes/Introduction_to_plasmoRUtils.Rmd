...
7.  [Malaria Cell Atlas](https://www.malariacellatlas.org/), etc. For exhaustive list, see subsections below.
...
Sometimes, it is difficult to keep track of the corpus while you are working on your gene of interest and you might want to keep up with your competing groups across the globe. `searchRS()` function can help you screen preprint corpus available at Research Square where your gene ID of interest has been mentioned and return the results in form of a data frame.
...
Some visualization functions have been developed to produce similar visualizations similar to what rendered by [malaria.tools](https://malaria.sbs.ntu.edu.sg/) database but are publication ready. User can plot Condition Specific and Stage Specific expression of gene of interest in two organisms: *Plasmodium falciparum* and *Plasmodium berghi.*
